...
# Paper list
* [Recurrent Convolutional Network for Video-based Person Re-Identification](201609.md#recurrent-convolutional-network-for-video-based-person-re-identification)
