...
=======
		where ![equation](http://latex.codecogs.com/svg.latex?b_%7BSIR%7D%2Cb_%7BCIR%7D%20is%20the%20distance%20threshold%20%28margin%29%2C%20%5Calpha_P) is the trade-off parameter, which is set to 0.0005 in the experiments
